const translations = {
    tr: {
        ...
        projects: {
            ...
            btnRun: 'Çalıştır',
            btnTest: 'Testleri Koş',
            btnBuild: 'Derle (Build)',
    ...
    en: {
        ...
        projects: {
            ...
            proj5: { title: 'Tarihi Sanayi Köftecisi', summary: 'Static promotional site for menu and contact info, deployed on GitHub Pages.', comment: '// Restaurant promotion website', name: '"Tarihi Sanayi Köftecisi"', desc: '"A responsive promotional website presenting the restaurant menu and contact information. Developed using HTML & CSS."', tech: ['HTML', 'CSS'], githubUrl: 'https://github.com/arincakyildiz/tarihi-sanayi-koftecisi', demoUrl:'https://tarihisanayikoftecisi.arincakyildiz.com.tr/', terminal: ['$ open index.html', '✓ Site deployed to GitHub Pages', '$ lighthouse --view'], branch: 'main', lang: 'HTML' },
